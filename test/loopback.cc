 ...
 * \ingroup madaodv
 *
 * \brief MADAODV loopback UDP echo test case
 */
 ...
 *
 * \brief MADAODV Loopback test suite
 */
class MadaodvLoopbackTestSuite : public TestSuite
{
  public:
    MadaodvLoopbackTestSuite()
        : TestSuite("routing-madaodv-loopback", SYSTEM)
    {
        SetDataDir(NS_TEST_SOURCEDIR);
        // UDP Echo loopback test case
        AddTestCase(new LoopbackTestCase(), TestCase::QUICK);
    }
} g_madaodvLoopbackTestSuite; ///< the test suite
