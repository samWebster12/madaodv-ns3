 ...
 *
 * Based on
 *      NS-2 MADMADAODV model developed by the CMU/MONARCH group and optimized and
 *      tuned by Samir Das and Mahesh Marina, University of Cincinnati;
 *
 *      MADMADAODV-UU implementation by Erik Nordström of Uppsala University
 *      https://web.archive.org/web/20100527072022/http://core.it.uu.se/core/index.php/MADAODV-UU
 *
...
/**
 * \defgroup madaodv-test MADAODV module tests
 * \ingroup madaodv
 * \ingroup tests
 */
...
class IdCacheTestSuite : public TestSuite
{
  public:
    IdCacheTestSuite()
        : TestSuite("madaodv-routing-id-cache", UNIT)
    {
